...
console.log(`${passwordMatch("haxj210*x2&")}`);
console.log(`${passwordMatch("haxj21&vhhjb78y7y98h98h")}`);
console.log(`${passwordMatch("knewcklnwpojèjcoewnopcnocewnocpwnkc")}`);
console.log(`${passwordMatch("2PxÑzuxa")}`);
console.log(`${passwordMatch(1234568)}`);
...
function payTaxes(age, income) {
    ...
    payTaxes(17, 700);
    payTaxes(15);
    payTaxes("nwcken",2332);
    payTaxes(25, "mxmxw`xm")
...
console.log(multipleOf(7));
console.log(multipleOf(25));
console.log(multipleOf(46));
console.log(multipleOf());
console.log(multipleOf("cneoeckenckpecn"));
console.log(multipleOf("%8f3nionbedib"));
